...
public static class TestData
{
    ...
    {
        new ChatMessageDto { Sender = ChatUserDtos(ownProfile)[0], Text = "Hello from me", IsDeleted = false, SentUtc = DateTime.UtcNow, AttachmentUrls = new string[] { "https://example.com/doc1.pdf" } },
        new ChatMessageDto { Sender = ChatUserDtos(ownProfile)[1], Text = "Hello from User 2", IsDeleted = false, SentUtc = DateTime.UtcNow, AttachmentUrls = new string[] { "https://example.com/doc2.pdf" } },
        new ChatMessageDto { Sender = ChatUserDtos(ownProfile)[2], Text = "Hello from User 3", IsDeleted = false, SentUtc = DateTime.UtcNow, AttachmentUrls = new string[] { "https://example.com/doc3.pdf" } }
    };
